...
void exponentialFunctionalTest(){
    ModelInterface* ModelExponential = new Model();
...
void logisticalFunctionalTest(){
    ModelInterface* ModelLogistic = new Model();
    SystemInt* p1= new System();
    p1->setValue(100.0);

    SystemInt* p2 = new System();
    p2->setValue(10.0);
...
void complexFunctionalTest(){
    SystemInt* q1 = new System();
    q1->setValue(100.0);
    SystemInt* q2 = new System();
    q2->setValue(0.0);
    SystemInt* q3 = new System();
    q3->setValue(100.0);
    SystemInt* q4 = new System();
    q4->setValue(0.0);
    SystemInt* q5 = new System();
    q5->setValue(0.0);
